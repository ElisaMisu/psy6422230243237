...
The data for this project was downloaded from the Office for National Statistics [website](https://www.ons.gov.uk/peoplepopulationandcommunity/culturalidentity/sexuality/datasets/sexualorientationfurtherpersonalcharacteristicsenglandandwalescensus2021). The original file (which can be found in the GitHub repository's data file) includes the code book and metadata on sheets on the corresponding sheets.
